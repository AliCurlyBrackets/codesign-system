 ...
 header start-->
        <nav class="admin-header navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            ...
            <div class="text-left navbar-brand-wrapper">
                <a class="navbar-brand brand-logo" href="index.html"><img src="{{ asset("assets/images/Logos.png") }}" alt=""></a>
            ...
            <ul class="nav navbar-nav ml-auto">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <div class="dropdown-header">
                            @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                                <h6>
                                    <a class="text-center d-block" rel="alternate" hreflang="{{ $localeCode }}" href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}">
                                        {{ $properties['native'] }}
                                    </a>
                                </h6>
                             @endforeach
                ...
                <li class="nav-item dropdown mr-30">
                    <a class="nav-link nav-pill user-avatar" data-toggle="dropdown" href="#" role="button"
                        aria-haspopup="true" aria-expanded="false">
                        <img src="{{asset("assets/images/users_photo_profile/user_avatar.png")}}" alt="avatar">
                    </a>
                    <div class="dropdown-menu dropdown-menu-right">
                        <div class="dropdown-header">
                            <div class="media">
